    ...
    <main className="w-full min-h-screen bg-white flex flex-col items-center">
      ...
      <div className="w-full aspect-[3/1] relative mb-12">
        <Image
          ...
          style={{ 
            objectPosition:
              currentSlug === 'casa-golf' ? 'center 65%' :
              currentSlug === 'casa-jm' ? 'center 65%' :
              currentSlug === 'casa-jj' ? 'center 50%' :
              currentSlug === 'casa-g' ? 'center 55%' :
              currentSlug === 'casa-fc' ? 'center 65%' :
              currentSlug === 'casa-valeria' ? 'center 70%' :
              (currentSlug === 'casa-sj' || currentSlug === 'casa-bg') ? 'center 78%' :
              currentSlug === 'casa-rz' ? 'center 55%' :
              currentSlug === 'casa-cs' ? 'center 55%' :
              (currentSlug === 'reforma-arcos' || currentSlug === 'reforma-callao') ? 'center 50%' :
              (currentSlug === 'reforma-ayacucho' || currentSlug === 'reforma-talcahuano' || currentSlug === 'reforma-pena-a') ? 'center 60%' :
              'bottom'
          }}
          priority
          sizes="100vw"
